...
HD_PWD='/home/quantaser/Github_RP/RedPitaya/fpga/prj/classic/project/redpitaya.runs/system_xlconstant_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_xlconstant_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_xlconstant_0.tcl
