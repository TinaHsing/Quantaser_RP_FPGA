...
#
# Generated by export_simulation on Tue Sep 24 18:16:54 +0800 2019
#
################################################################################
...
switch to the './multiplier2.sh' script.

./multiplier2.sh -reset_run
...
./multiplier2.sh -noclean_files

For more information on the script, please type './multiplier2.sh -help'.
