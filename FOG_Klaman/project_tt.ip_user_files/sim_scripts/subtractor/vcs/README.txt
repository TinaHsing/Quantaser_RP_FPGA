...
#
# Generated by export_simulation on Mon Oct 14 16:03:57 +0800 2019
#
################################################################################
...
switch to the './subtractor.sh' script.

./subtractor.sh -reset_run
...
./subtractor.sh -noclean_files

For more information on the script, please type './subtractor.sh -help'.
