...
HD_PWD='C:/Users/adam/Documents/Quantaser_RP_FPGA/kalman_sim/kalman_sim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kalman.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kalman.tcl
