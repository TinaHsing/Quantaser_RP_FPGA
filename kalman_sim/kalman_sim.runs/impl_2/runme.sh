...
HD_PWD='C:/Users/adam/Documents/Quantaser_RP_FPGA/kalman_sim/kalman_sim.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log kalman.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kalman.tcl -notrace
