...
#
# Generated by Vivado on Tue Oct 08 16:09:58 +0800 2019
# IP Build 1909766 on Thu Jun 15 19:58:00 MDT 2017 
#
# usage: divider2.sh [-help]
# usage: divider2.sh [-lib_map_path]
# usage: divider2.sh [-noclean_files]
# usage: divider2.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "divider2.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./divider2.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
map_local_libs()
{
  ...
  local_libs=(xbip_utils_v3_0_7 axi_utils_v2_0_3 xbip_pipe_v3_0_3 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_3 xbip_bram18k_v3_0_3 mult_gen_v12_0_12 floating_point_v7_0_13 xbip_dsp48_mult_v3_0_3 xbip_dsp48_multadd_v3_0_3 div_gen_v5_1_11)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb divider2.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./divider2.sh -help\" for more information)\n"
    exit 1
  fi
