...
map_local_libs()
{
  ...
  local_libs=(xbip_utils_v3_0_7 xbip_pipe_v3_0_3 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_3)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb divider3.wdb xsim.dir)
