...
#
# Generated by Vivado on Thu Oct 10 18:23:59 +0800 2019
...
# Script info
echo -e "adder.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_7 -L c_reg_fd_v12_0_3 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_pipe_v3_0_3 -L xbip_dsp48_addsub_v3_0_3 -L xbip_addsub_v3_0_3 -L c_addsub_v12_0_10 -L xil_defaultlib -L secureip -L xpm --snapshot adder xil_defaultlib.adder -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim adder -key {Behavioral:sim_1:Functional:adder} -tclbatch cmd.tcl -log simulate.log
}
